...
<div class="center">
  <div class="row" style="align-items:flex-end; justify-content: center;">
    ...
    <div class="group" style="margin-left:3rem; height:80px; max-width:3rem;min-width:3rem;margin-bottom:-1rem ">
  ...
  <div class="container row">
    {#each data as o, i}
      <div class="group" style=" height:100%;">
        ...
        <div class="bar" style="height:{yScale(o.approvals)}%; bottom:{yScale(o.already)}%; left:50%;" />
      </div>
    {/each}
