var app = (function () {
    ...
    const file = "Users/spencer/mountain/somehow-sankey/src/Dots.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(circle, file, 25, 6, 449);
    ...
    class Dots extends SvelteComponentDev$1 {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance, create_fragment, safe_not_equal$1, { color: 0 });
    ...
    const file$1 = "Users/spencer/mountain/somehow-sankey/src/Sankey.svelte";
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$1, 54, 10, 1534);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$1, 62, 10, 1786);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    			append_dev$1(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*fmt, nodes*/ 10 && t_value !== (t_value = /*fmt*/ ctx[1](/*d*/ ctx[15].value) + "")) set_data_dev(t, t_value);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "tiny", /*d*/ ctx[15].height < 75);
    			add_location$1(div, file$1, 71, 10, 2003);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    			append_dev$1(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*nodes*/ 8 && t_value !== (t_value = /*d*/ ctx[15].percent + "")) set_data_dev(t, t_value);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$1, 80, 10, 2224);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    			append_dev$1(div, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*nodes*/ 8 && t_value !== (t_value = /*d*/ ctx[15].append + "")) set_data_dev(t, t_value);
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div2, file$1, 39, 6, 1056);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if ((!current || dirty & /*nodes*/ 8) && t2_value !== (t2_value = /*d*/ ctx[15].name + "")) set_data_dev(t2, t2_value);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div6, file$1, 88, 6, 2391);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(path, file$1, 109, 6, 3009);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div0, file$1, 37, 2, 958);
    ...
    class Sankey extends SvelteComponentDev$1 {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-7h5ydy-style")) add_css();
    		init$1(this, options, instance$1, create_fragment$1, safe_not_equal$1, { height: 0, nodeWidth: 8, fmt: 1 });
    ...
    const file$2 = "Users/spencer/mountain/somehow-sankey/src/Col.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element$1("div");
    			if (default_slot) default_slot.c();
    			add_location$1(div, file$2, 11, 0, 191);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "2022/riding-sankey/Post.svelte";

    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-9o6vm9-style";
    	style.textContent = ".col.svelte-9o6vm9{display:flex;flex-direction:column;align-items:center}.center.svelte-9o6vm9{text-align:center;margin:3rem}.container.svelte-9o6vm9{max-width:800px;min-width:650px;flex-grow:1;margin-top:3rem}.source.svelte-9o6vm9{margin:1rem;font-size:12px;color:grey;text-align:right}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_each_block$1(ctx) {
    	...
    	node = new Node({
    			props: {
    				...
    				value: /*a*/ ctx[3].total,
    				label: "5%",
    				accent: /*colors*/ ctx[1][/*a*/ ctx[3].name],
    				color: /*colors*/ ctx[1][/*a*/ ctx[3].name],
    				after: /*i*/ ctx[5] > 6,
    				inline: /*i*/ ctx[5] === 5 || /*i*/ ctx[5] === 6,
    				show_percent: /*i*/ ctx[5] < 7,
    				show_num: false,
    				show_label: /*i*/ ctx[5] < 4
    			},
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(71:8) {#each counts as a, i}",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(66:4) <Sankey height=\\\"700\\\" {fmt}>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div3 = element("div");
    			div0 = element("div");
    			div0.textContent = "Active housing applications by Ward";
    			t1 = space();
    			div2 = element("div");
    			...
    			add_location(div0, file$3, 63, 2, 1801);
    			attr_dev(a, "href", "https://open.toronto.ca/dataset/building-permits-active-permits/");
    			add_location(a, file$3, 114, 6, 3249);
    			attr_dev(div1, "class", "source svelte-9o6vm9");
    			add_location(div1, file$3, 113, 4, 3222);
    			attr_dev(div2, "class", "container svelte-9o6vm9");
    			add_location(div2, file$3, 64, 2, 1882);
    			attr_dev(div3, "class", "center col svelte-9o6vm9");
    			add_location(div3, file$3, 62, 0, 1774);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(sankey, div2, null);
    			append_dev(div2, t2);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	return [sum, colors, fmt];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-9o6vm9-style")) add_css$1();
