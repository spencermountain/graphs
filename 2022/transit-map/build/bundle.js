var app = (function (mapboxgl) {
    ...
    function add_css$3() {
    	var style = element("style");
    	style.id = "svelte-1ly9nrh-style";
    	style.textContent = "#map.svelte-1ly9nrh{min-width:100%;min-height:750px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (38:0) <Page {title} grow={true} padding={0}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "map");
    			attr_dev(div, "class", "svelte-1ly9nrh");
    			add_location(div, file$3, 38, 2, 1046);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(38:0) <Page {title} grow={true} padding={0}>",
    		ctx
    	});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	mapboxgl__default['default'].accessToken = "pk.eyJ1Ijoic3BlbmNlcm1vdW50" + "YWluIiwiYSI6Inp5UVZEY3cifQ.dh-_SvkPgv9YOQZLG5ZHKg";
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1ly9nrh-style")) add_css$3();
