var app = (function (mapboxgl) {
    ...
    const file$2 = "2022/transit-map/Post.svelte";

    function add_css$2() {
    	var style = element("style");
    	style.id = "svelte-1140bbz-style";
    	style.textContent = ".m1.svelte-1140bbz{margin:1rem}.container.svelte-1140bbz{border:1px solid grey;border-radius:5px;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2);margin:5%;padding:0px;overflow:hidden}#map.svelte-1140bbz{min-width:100%;min-height:750px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	head = new Head({
    			props: { title: /*title*/ ctx[0], num: "10" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-1140bbz");
    			add_location(div0, file$2, 43, 6, 1239);
    			attr_dev(div1, "class", "container svelte-1140bbz");
    			add_location(div1, file$2, 42, 4, 1209);
    			set_style(div2, "position", "relative");
    			add_location(div2, file$2, 41, 2, 1172);
    			attr_dev(div3, "class", "m1 svelte-1140bbz");
    			add_location(div3, file$2, 39, 0, 1125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1140bbz-style")) add_css$2();
