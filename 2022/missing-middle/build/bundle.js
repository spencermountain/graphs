var app = (function () {
    ...
    const file$5 = "2022/missing-middle/Post.svelte";

    function add_css$3() {
    	var style = element("style");
    	style.id = "svelte-1y0nv5b-style";
    	style.textContent = ".center.svelte-1y0nv5b{text-align:center;margin:3rem;display:flex;flex-direction:column;justify-content:space-around;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.container.svelte-1y0nv5b{position:relative;max-width:800px;min-width:400px;margin-top:3rem}.source.svelte-1y0nv5b{margin:3rem;font-size:12px;color:grey;text-align:right}.label.svelte-1y0nv5b{position:absolute;min-width:200px;top:73%;left:460px;color:#c4abab}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(28:4) <Sankey height=\\\"700\\\" {fmt}>",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 25, 6, 688);
    			attr_dev(div1, "class", "label svelte-1y0nv5b");
    			add_location(div1, file$5, 23, 4, 639);
    			attr_dev(a, "href", "https://open.toronto.ca/dataset/building-permits-active-permits/");
    			add_location(a, file$5, 57, 15, 1720);
    			attr_dev(div2, "class", "source svelte-1y0nv5b");
    			add_location(div2, file$5, 56, 4, 1684);
    			attr_dev(div3, "class", "container svelte-1y0nv5b");
    			add_location(div3, file$5, 22, 2, 611);
    			attr_dev(div4, "class", "center svelte-1y0nv5b");
    			add_location(div4, file$5, 21, 0, 588);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div1, div0);
    			append_dev(div3, t3);
    			mount_component(sankey, div3, null);
    			append_dev(div3, t4);
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1y0nv5b-style")) add_css$3();
