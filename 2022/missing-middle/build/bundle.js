var app = (function () {
    ...
    var counts = [
      ...
      { name: 'Single units', total: 9171, pending: 878, issued: 8293 },
    ];
    ...
    const file$3 = "2022/missing-middle/Post.svelte";

    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-ld8to1-style";
    	style.textContent = ".center.svelte-ld8to1{text-align:center;margin:3rem}.container.svelte-ld8to1{max-width:800px;min-width:400px;margin-top:3rem}.source.svelte-ld8to1{margin:3rem;font-size:12px;color:grey;text-align:right}.m3.svelte-ld8to1{}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(33:4) <Sankey height=\\\"700\\\" {fmt}>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div3 = element("div");
    			div0 = element("div");
    			div0.textContent = "Development applications by number of units";
    			t1 = space();
    			div2 = element("div");
    			...
    			t3 = text("filtered ");
    			a = element("a");
    			a.textContent = "Active building permits";
    			t5 = text("\n      - toronto.ca, Sep 2022");
    			attr_dev(div0, "class", "m3 svelte-ld8to1");
    			add_location(div0, file$3, 30, 2, 793);
    			attr_dev(a, "href", "https://open.toronto.ca/dataset/building-permits-active-permits/");
    			add_location(a, file$3, 62, 15, 1872);
    			attr_dev(div1, "class", "source svelte-ld8to1");
    			add_location(div1, file$3, 61, 4, 1836);
    			attr_dev(div2, "class", "container svelte-ld8to1");
    			add_location(div2, file$3, 31, 2, 861);
    			attr_dev(div3, "class", "center svelte-ld8to1");
    			add_location(div3, file$3, 29, 0, 770);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-ld8to1-style")) add_css$1();
