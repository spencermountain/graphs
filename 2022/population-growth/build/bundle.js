var app = (function () {
    ...
    */
    ...
    const file$2 = "2022/population-growth/xAxis.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 10, 4, 363);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 8, 0, 315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class XAxis extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1elq6nq-style")) add_css$2();
    ...
    const file$3 = "2022/population-growth/yAxis.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 19, 4, 412);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 17, 0, 368);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class YAxis extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1t69a8p-style")) add_css$3();
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { yScale: 0 });
    ...
    function add_css$4() {
    	...
    	style.textContent = ".top-stat.svelte-1luaz8f{font-size:15px;color:grey;right:-40px;position:absolute;top:-55px;line-height:1.2rem}.col.svelte-1luaz8f{text-align:center;margin-top:4rem}.today.svelte-1luaz8f{height:80%;position:absolute;top:18%;border-left:2px dashed grey}.container.svelte-1luaz8f{position:relative;min-width:600px;aspect-ratio:1.618/1}.mayor.svelte-1luaz8f{position:absolute;font-size:18px;color:grey}svg.svelte-1luaz8f{overflow:visible;position:relative}.all.svelte-1luaz8f{margin:4rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:6) {#each terms as term, i}",
    		ctx
    	});
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 63, 6, 1942);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:4) {#each terms as term, i}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	head = new Head({
    			props: { title: /*title*/ ctx[3], num: "04" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$5, 35, 35, 1094);
    			add_location(br1, file$5, 35, 48, 1107);
    			attr_dev(div0, "class", "top-stat svelte-1luaz8f");
    			add_location(div0, file$5, 35, 4, 1063);
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1luaz8f-style")) add_css$4();
