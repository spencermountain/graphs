var app = (function () {
    ...
    const file = "Users/spencer/mountain/somehow-calendar/src/Month.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file, 68, 10, 1971);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div0, file, 65, 12, 1897);
    			...
    			add_location$1(div1, file, 52, 10, 1390);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*weeks*/ 4 && t_value !== (t_value = /*d*/ ctx[19].num + "")) set_data_dev(t, t_value);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file, 49, 4, 1316);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div0, file, 47, 2, 1239);
    			attr_dev$1(div1, "class", "month");
    			set_style$1(div1, "width", "100%");
    			add_location$1(div1, file, 46, 0, 1197);
    		},
    ...
    class Month extends SvelteComponentDev$1 {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1dblamv-style")) add_css();
    ...
    const file$1 = "Users/spencer/mountain/somehow-calendar/src/Quarter.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$1, 16, 4, 428);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$1, 14, 0, 384);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "2022/bluejays-calendar/Post.svelte";

    function add_css$2() {
    	var style = element("style");
    	style.id = "svelte-1o2k1lr-style";
    	style.textContent = ".m3.svelte-1o2k1lr{margin:3rem}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 20, 2, 447);
    			add_location(div1, file$2, 19, 0, 439);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Quarter, games, tops, bottoms, isHome });
    	...
    	return [tops, bottoms, isHome];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1o2k1lr-style")) add_css$2();
