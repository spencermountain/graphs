...
},{"../../parse":24}],40:[function(_dereq_,module,exports){
"use strict";

// world population by year
//https://www.worldometers.info/world-population/world-population-by-year/
module.exports = [[2019, 7714576923], [2018, 7632819325], [2017, 7550262101], [2016, 7466964280], [2015, 7383008820], [2014, 7298453033], [2013, 7213426452], [2012, 7128176935], [2011, 7043008586], [2010, 6958169159], [2009, 6873741054], [2008, 6789771253], [2007, 6706418593], [2006, 6623847913], [2005, 6542159383], [2004, 6461370865], [2003, 6381408987], [2002, 6302149639], [2001, 6223412158], [2000, 6145006989], [1999, 6066867391], [1998, 5988846103], [1997, 5910566295], [1996, 5831565020], [1995, 5751474416], [1994, 5670319703], [1993, 5588094837], [1992, 5504401149], [1991, 5418758803], [1990, 5330943460], [1989, 5240735117], [1988, 5148556956], [1987, 5055636132], [1986, 4963633228], [1985, 4873781796], [1984, 4786483862], [1983, 4701530843], [1982, 4618776168], [1981, 4537845777], [1980, 4458411534], [1979, 4380585755], [1978, 4304377112], [1977, 4229201257], [1976, 4154287594], [1975, 4079087198], [1974, 4003448151], [1973, 3927538695], [1972, 3851545181], [1971, 3775790900], [1970, 3700577650], [1969, 3625905514], [1968, 3551880700], [1967, 3479053821], [1966, 3408121405], [1965, 3339592688], [1964, 3273670772], [1963, 3210271352], [1962, 3149244245], [1961, 3090305279], [1960, 3033212527], [1959, 2977824686], [1958, 2924081243], [1957, 2871952278], [1956, 2821383444], [1955, 2772242535], [1954, 2724302468], [1953, 2677230358], [1952, 2630584384], [1951, 2583816786], [1927, 2000000000], [1910, 1750000000], [1900, 1600000000], [1850, 1200000000], [1804, 1000000000], [1760, 770000000], [1700, 610000000], [1600, 500000000], [1500, 450000000], [1400, 350000000], [1200, 360000000], [1100, 320000000], [1000, 275000000], [900, 240000000], [800, 220000000], [700, 210000000], [600, 200000000], [200, 190000000] // [-200, 150000000],
// [-500, 100000000],
// [-1000, 50000000],
// [-2000, 27000000],
// [-3000, 14000000],
...
},{"dup":1}],42:[function(_dereq_,module,exports){
arguments[4][2][0].apply(exports,arguments)
},{"d3-path":41,"dup":2}],43:[function(_dereq_,module,exports){
arguments[4][3][0].apply(exports,arguments)
},{"dup":3}],44:[function(_dereq_,module,exports){
arguments[4][4][0].apply(exports,arguments)
},{"dup":4}],45:[function(_dereq_,module,exports){
(function (global){
/* somehow v0.0.8
...
module.exports={
  ...
  "_id": "somehow@0.1.3",
  "_inBundle": false,
  "_integrity": "sha512-K1Zp1RDdl8bD9duQuuE06lDC1KOx7583jJSjL3vz9czXLtRGXkPNaa0XkGXxO9emHIa3eCtEjctli4I8BywmAg==",
  "_location": "/somehow",
  "_phantomChildren": {},
  "_requested": {
    "type": "version",
  ...
  "_resolved": "https://registry.npmjs.org/somehow/-/somehow-0.1.3.tgz",
  "_shasum": "c918fb254a43a34a8094176cdfc5734caf12a922",
  "_spec": "somehow@0.1.3",
  "_where": "/Users/spencer/mountain/thensome/drafts/generations-of-people",
  "author": {
    "name": "Spencer Kelly",
    "url": "spencermountain"
  },
...
},{"./_clip":49,"./axis/XAxis":52,"./axis/YAxis":53,"./methods":58,"./scales/Scale":60,"./scales/YScale":61,"./shapes/Annotation":63,"./shapes/Area":64,"./shapes/Arrow":65,"./shapes/Bar":66,"./shapes/Dot":67,"./shapes/Image":68,"./shapes/Line":69,"./shapes/MidArea":70,"./shapes/Rect":71,"./shapes/Shape":72,"./shapes/Text":73,"fit-aspect-ratio":43,"htm":44,"vhtml":80}],49:[function(_dereq_,module,exports){
//remove shapes outside of boundaries
...
},{"./_custom":54,"./_ticks":56,"spencer-color":79}],52:[function(_dereq_,module,exports){
...
},{"./Axis":51}],53:[function(_dereq_,module,exports){
const Axis = _dereq_('./Axis')
...
},{"./Axis":51}],54:[function(_dereq_,module,exports){
const spacetime = _dereq_('spacetime')
...
},{"./_prettyNum":55,"spacetime":78}],55:[function(_dereq_,module,exports){
...
},{"somehow-ticks":46,"spacetime-ticks":76}],57:[function(_dereq_,module,exports){
...
},{"../package.json":47,"./World":48}],58:[function(_dereq_,module,exports){
...
},{"./_fns":50,"./parse":59}],59:[function(_dereq_,module,exports){
const spacetime = _dereq_('spacetime')
//
...
},{"spacetime":78}],60:[function(_dereq_,module,exports){
// const scaleLinear = require('d3-scale').scaleLinear
...
},{"../parse":59,"./_linear":62}],61:[function(_dereq_,module,exports){
...
},{"../parse":59,"./Scale":60,"./_linear":62}],62:[function(_dereq_,module,exports){
//a very-tiny version of d3-scale's scaleLinear
...
},{"./Text":73,"spencer-color":79}],64:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":59,"./Shape":72,"d3-shape":42,"spencer-color":79}],65:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":72,"d3-shape":42,"spencer-color":79}],66:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":59,"./Rect":71,"spencer-color":79}],67:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":72,"spencer-color":79}],68:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":72,"spencer-color":79}],69:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":72,"d3-shape":42,"spencer-color":79}],70:[function(_dereq_,module,exports){
...
},{"../parse":59,"./Area":64,"./lib/parseInput":74,"d3-shape":42}],71:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":72,"spencer-color":79}],72:[function(_dereq_,module,exports){
const d3Shape = _dereq_('d3-shape')
const colors = _dereq_('spencer-color').colors
const fns = _dereq_('../_fns')
const parseInput = _dereq_('./lib/parseInput')
...
},{"../_fns":50,"../parse":59,"./lib/parseInput":74,"d3-shape":42,"spencer-color":79}],73:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":72,"spencer-color":79}],74:[function(_dereq_,module,exports){
const { parseX, parseY } = _dereq_('../../parse')
...
},{"../../parse":59}],75:[function(_dereq_,module,exports){
arguments[4][6][0].apply(exports,arguments)
},{"dup":6}],76:[function(_dereq_,module,exports){
arguments[4][7][0].apply(exports,arguments)
},{"./methods":77,"dup":7,"spacetime":78}],77:[function(_dereq_,module,exports){
arguments[4][8][0].apply(exports,arguments)
},{"./_reduce":75,"dup":8}],78:[function(_dereq_,module,exports){
arguments[4][9][0].apply(exports,arguments)
},{"dup":9}],79:[function(_dereq_,module,exports){
arguments[4][10][0].apply(exports,arguments)
},{"dup":10}],80:[function(_dereq_,module,exports){
arguments[4][11][0].apply(exports,arguments)
},{"dup":11}],81:[function(_dereq_,module,exports){
"use strict";

var lifespan = 70; // const somehow = require('somehow')

var somehow = _dereq_('/Users/spencer/mountain/somehow/src');

var spacetime = _dereq_('spacetime');

var showEvents = _dereq_('./events');

var drawWorld = _dereq_('./world');

var h = 15;
var mNames = ['you', 'father', 'grandfather'];
var fNames = ['you', 'mother', 'grandmother'];
...
var drawIt = function drawIt(gens, age, genLength, gender) {
  var height = 200;
  ...
  var d = spacetime.now().minus(age, 'years');

  for (var i = 0; i < gens; i += 1) {
    var end = d.add(lifespan, 'years');
    ...
    w.line().set([[d.iso(), i], [end.iso(), i]]); //draw text

    var name = gender === 'maternal' ? fNames[i] : mNames[i];

    if (!name) {
      name = toOrdinal(i) + ' gen'; // name += gender === 'maternal' ? ' mother' : ' father'
    }

    w.text(name).at(d.iso(), i).font(9).dy(2).dx(5);
    d = d.minus(genLength, 'years');
  }

  w.fit(); // console.time('ticks')
  // w.xAxis.ticks(10)
  ...
  console.timeEnd('build'); //re-draw earth population graph too
  // console.time('earth')
  // drawWorld(d.iso())
...
},{"./events":82,"./world":84,"/Users/spencer/mountain/somehow/src":22,"spacetime":78}],82:[function(_dereq_,module,exports){
"use strict";

var year = new Date().getFullYear();
var dy = '15px';
var events = [['Dec 5 1492', ['columbus', 'landing']], ['Dec 5 1206', ['Genghis', 'Khan']] // ['Dec 5 1880', ['Electricity']]
]; // const eras = [
//   ['Dec 5 1550', 'Dec 5 1880', 'english', 'yellow'],
//   ['Dec 5 1880', new Date(), 'electricity', 'pink']
// ]

var showEvents = function showEvents(w) {
  //ww2
  w.rect().color('red').set([['Sep 1 1939', '0%'], ['Sep 2 1945', '100%']]).rounded(1);
  w.text('WWII').center('Sep 1 1941', '-30px').font(12); //ww1

  w.rect().color('red').set([['Jul 28 1914', '0%'], ['Nov 11 1918', '100%']]).rounded(1);
  w.text('WWI').center('Sep 1 1916', '-30px').font(12); //centuries

  for (var c = 900; c < year; c += 100) {
    w.line().set([["Jan 1 ".concat(c), '0%'], ["Jan 1 ".concat(c), '100%']]).dotted(true).width(1).color('grey');
  } //other events


  events.forEach(function (event) {
    w.text(event[1]).center(event[0], dy).font(12);
  }); // eras.forEach(era => {
  //   w.line()
...
document.querySelector('#age').innerHTML = ageSlider.build(); // let genderSelect = inputs.select({
//   width: 800,
//   value: 'paternal',
...
},{"./draw":81,"somehow-input":45}],84:[function(_dereq_,module,exports){
"use strict";
...
var population = _dereq_('../data/world-population');

var drawIt = function drawIt() {
  var start = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Jan 1 1600';
  var w = somehow({
    height: 200,
    width: 800
  });
  var year = spacetime(start).year();
  console.log(year);
  var data = population.filter(function (a) {
    return a[0] > year;
  });
...
},{"../data/world-population":40,"somehow":57,"spacetime":78}]},{},[83]);
