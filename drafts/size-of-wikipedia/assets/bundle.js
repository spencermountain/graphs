...
(function (f) {
  ...
  return function () {
    ...
    4: [function (_dereq_, module, exports) {
      !function () {
        ...
        function t(e) {
          ...
          return (n[t] || (n[t] = i(e)))(this, arguments);
        }

        var i = function i(n) {
          for (var t, i, c, r, s, o = 0, u = "return ", a = "", f = "", h = 0, l = "", g = "", d = "", v = 0, m = function m() {
            c ? 9 === o ? (h++ && (u += ","), u += "h(" + (f || e(a)), o = 0) : 13 === o || 0 === o && "..." === a ? (0 === o ? (d || (d = ")", l = l ? "Object.assign(" + l : "Object.assign({}"), l += g + "," + f, g = "") : r && (l += l ? "," + (g ? "" : "{") : "{", g = "}", l += e(r) + ":", l += f || (s || a) && e(a) || "true", r = ""), s = !1) : 0 === o && (o = 13, r = a, a = f = "", m(), o = 0) : (f || (a = a.replace(/^\s*\n\s*|\s*\n\s*$/g, ""))) && (h++ && (u += ","), u += f || e(a)), a = f = "";
          }, p = 0; p < n.length; p++) {
            p > 0 && (c || m(), f = "$[" + p + "]", m());

            for (var O = 0; O < n[p].length; O++) {
              if (i = n[p].charCodeAt(O), c) {
                if (39 === i || 34 === i) {
                  if (v === i) {
                    v = 0;
                    continue;
                ...
                if (0 === v) switch (i) {
                  case 62:
                    m(), 47 !== o && (u += l ? "," + l + g + d : ",null"), t && (u += ")"), c = 0, l = "", o = 1;
                    continue;
          ...
          return m(), Function("h", "$", u);
        };

        "undefined" != typeof module ? module.exports = t : self.htm = t;
      }();
    }, {}],
        ...
        (function (f) {
          ...
          return function () {
            ...
            7: [function (_dereq_, module, exports) {
              "use strict"; //https://www.timeanddate.com/calendar/aboutseasons.html
            ...
            32: [function (_dereq_, module, exports) {
              ...
              var qualifiers = {
                ...
                seconds: {
                  almost: 50,
                  over: 20 //get number of hours/minutes... between the two dates
            ...
            43: [function (_dereq_, module, exports) {
              "use strict"; //prefixes for iana names..
            ...
            44: [function (_dereq_, module, exports) {
              "use strict"; // this is a very rough list of informal and abbreviated timezones
        ...
        !function (e) {
          ...
          return function u(i, a, c) {
            function f(r, e) {
              if (!a[r]) {
                if (!i[r]) {
                  var o = "function" == typeof _dereq_ && _dereq_;
                  if (!e && o) return o(r, !0);
                  if (d) return d(r, !0);
            ...
            for (var d = "function" == typeof _dereq_ && _dereq_, e = 0; e < c.length; e++) {
              f(c[e]);
            }
    ...
    27: [function (_dereq_, module, exports) {
      "use strict"; //a very-tiny version of d3-scale's scaleLinear
...
var current = 231700; // const growth = 0.97
//

var pagesPerYear = function pagesPerYear() {
  var growth = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.97;
  var guess = [];
  var perYear = current;
  var endYear = new Date().getFullYear() + 102;

  for (var i = 2019; i < endYear; i += 1) {
...
var somehow = _dereq_('/Users/spencer/mountain/somehow');

var pagesPerYear = _dereq_('./growth-compute');

var articleCount = 5793009; //5,793,009
...
var newArticles = [['2002-01-01', 19700], ['2003-01-01', 76800], ['2004-01-01', 92300], ['2005-01-01', 249700], ['2006-01-01', 456500], ['2007-01-01', 665000], ['2008-01-01', 593000], ['2009-01-01', 526000], ['2010-01-01', 465000], ['2011-01-01', 374000], ['2012-01-01', 317000], ['2013-01-01', 298000], ['2014-01-01', 280000], ['2015-01-01', 269000], ['2016-01-01', 363000], ['2017-01-01', 276200], ['2018-01-01', 220700], ['2019-01-01', 231700]];
w.area().color('blue').set(newArticles);
var projection = pagesPerYear(0.97);
w.area().color('lightblue').set(projection); //annotation for current size

var last = newArticles[newArticles.length - 1];
w.annotation('5.7m articles').size(18).at(last[0], last[1]).nudge(40, 60); //add annotation for total article count

var total = articleCount;
projection.forEach(function (a) {
  return total += a[1];
});
var num = (total / 1000000).toFixed(1);
var text = [num + 'm articles'];
last = projection[projection.length - 1];
w.annotation(text).size(18).at(last[0], last[1]).nudge(-160, 60);
w.y.fit();
w.x.fit();
var el = document.querySelector('#growth');
el.innerHTML = w.build(); // let id = 'growthRate'
...
},{"./growth-compute":2,"/Users/spencer/mountain/somehow":1}],4:[function(_dereq_,module,exports){
"use strict";
...
},{"./growth":3,"./reading":6}],5:[function(_dereq_,module,exports){
"use strict";
...
var wordsPerPage = 483;

var growthPerYear = _dereq_('./growth-compute');

var growth = growthPerYear().reduce(function (h, a) {
  h[a[0].replace(/-.*/, '')] = a[1];
  return h;
}, {});

var compute = function compute(wordsPerMinute, hoursPerDay, daysPerYear) {
  var wordsPerDay = wordsPerMinute * 60 * hoursPerDay;
  var pagesPerDay = wordsPerDay / wordsPerPage;
  var pagesPerYear = pagesPerDay * daysPerYear; //compute each year

  var points = [];
  var pagesRead = 0;

  for (var i = thisYear; i < endyear; i += 1) {
    articleCount += growth[i];
    pagesRead += pagesPerYear;
    var percent = pagesRead / articleCount * 100;
    percent = parseInt(percent, 10);
    points.push(["jan 1 ".concat(i), percent]);
...
module.exports = compute; // compute(250, 8, 252, 200000)

},{"./growth-compute":2}],6:[function(_dereq_,module,exports){
"use strict";

var somehow = _dereq_('/Users/spencer/mountain/somehow');

var compute = _dereq_('./reading-compute');
...
var id = 'wordsPerMinute';
var wordsPerMinute = w.slider({
  id: id,
  min: 120,
  value: 250,
  max: 400
...
var drawGraph = function drawGraph() {
  ...
  var text = [last[1] + '% complete'];
  w.annotation(text).size(18).at(last[0], last[1]).nudge(-160, 20);
  w.y.fit(0, 100);
  var endYear = new Date().getFullYear() + 101;
  w.x.fit('jan 1 2002', "jan 1 ".concat(endYear));
  document.querySelector('#stage').innerHTML = w.build();
};

drawGraph();

},{"./reading-compute":5,"/Users/spencer/mountain/somehow":1}]},{},[4]);
