...
var somehow = _dereq_('somehow'); //days in earth-hours
...
var planets = [{
  ...
  day: 24.37,
  year: 686.98,
  color: 'red' // { name: 'jupiter', day: 9.83, year: 4332.589, color: 'yellow' },
...
var graphs = planets.map(function (obj) {
  var year = obj.year * 23.56;
  var w = somehow({
    height: 40,
    width: 800
  }); //draw days
  ...
  for (var n = 0; n < year; n += obj.day) {
    // console.log(n, obj.name)
    w.line().set([[n, 2], [n + obj.day * 0.7, 2]]).color(obj.color);
    dayCount += 1;
  }

  console.log(dayCount, obj.name);
  w.line().set([[0, 1], [year, 1]]).color('grey');
...
},{"somehow":18}],2:[function(_dereq_,module,exports){
...
module.exports={
  ...
  "_spec": "somehow@0.1.4",
  "_where": "/Users/spencer/mountain/thensome/drafts/solar system calendar",
  "author": {
    "name": "Spencer Kelly",
    "url": "spencermountain"
  },
...
},{"./_prettyNum":16,"spacetime":41}],16:[function(_dereq_,module,exports){
...
},{"somehow-ticks":6,"spacetime-ticks":39}],18:[function(_dereq_,module,exports){
...
},{"../package.json":8,"./World":9}],19:[function(_dereq_,module,exports){
...
},{"spacetime":41}],21:[function(_dereq_,module,exports){
...
},{"./Text":35,"spencer-color":7}],25:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":20,"./Shape":34,"d3-shape":3,"spencer-color":7}],26:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":34,"d3-shape":3,"spencer-color":7}],27:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"../parse":20,"./Rect":33,"spencer-color":7}],28:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":34,"spencer-color":7}],29:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":34,"spencer-color":7}],30:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const d3Shape = _dereq_('d3-shape')
const Shape = _dereq_('./Shape')
...
},{"./Shape":34,"d3-shape":3,"spencer-color":7}],31:[function(_dereq_,module,exports){
...
},{"../parse":20,"./Area":25,"./lib/parseInput":37,"d3-shape":3}],32:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
...
},{"./Line":30,"spencer-color":7}],33:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Shape = _dereq_('./Shape')
...
},{"./Shape":34,"spencer-color":7}],34:[function(_dereq_,module,exports){
const d3Shape = _dereq_('d3-shape')
const colors = _dereq_('spencer-color').colors
const fns = _dereq_('../_fns')
const parseInput = _dereq_('./lib/parseInput')
...
},{"../_fns":11,"../parse":20,"./lib/parseInput":37,"d3-shape":3,"spencer-color":7}],35:[function(_dereq_,module,exports){
const Shape = _dereq_('./Shape')
const colors = _dereq_('spencer-color').colors
...
},{"./Shape":34,"spencer-color":7}],36:[function(_dereq_,module,exports){
const colors = _dereq_('spencer-color').colors
const Text = _dereq_('./Text')
...
},{"./Text":35,"spencer-color":7}],37:[function(_dereq_,module,exports){
const { parseX, parseY } = _dereq_('../../parse')
...
},{"../../parse":20}],38:[function(_dereq_,module,exports){
...
},{"./methods":40,"spacetime":41}],40:[function(_dereq_,module,exports){
...
},{"./_reduce":38}],41:[function(_dereq_,module,exports){
(function (global){
/* spacetime v5.9.0
