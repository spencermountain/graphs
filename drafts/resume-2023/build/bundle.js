var app = (function () {
    ...
    */
    ...
    /* drafts/resume-2023/Post.svelte generated by Svelte v3.29.0 */

    const { console: console_1 } = globals;
    const file$2 = "drafts/resume-2023/Post.svelte";

    function add_css$2() {
    	var style = element("style");
    	style.id = "svelte-7kikew-style";
    	style.textContent = ".bar.svelte-7kikew{position:absolute;border-radius:2px;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2);background-color:steelblue;color:#f1f0ef;font-size:12px;height:24px}.line.svelte-7kikew{position:relative;border-left:1px solid grey;width:2px;height:30px;margin-left:20px;padding-bottom:-15px;margin-top:5px}.label.svelte-7kikew{position:absolute;color:grey;margin-left:-20px;text-align:left;width:10px;font-size:12px;white-space:nowrap}.above.svelte-7kikew{position:absolute;color:grey;margin-left:5px;text-align:left;width:10px;margin-top:-20px;font-size:10px;font-style:italic;white-space:nowrap}.axis.svelte-7kikew{position:absolute;color:grey;margin-left:-20px;text-align:left;width:10px;bottom:15px;font-size:10px;opacity:0.8;white-space:nowrap}.full.svelte-7kikew{position:relative;width:100%;height:300px;margin-top:4rem;margin-bottom:9rem}.row.svelte-7kikew{display:flex;flex-direction:row;justify-content:space-around;align-items:center;text-align:center;flex-wrap:wrap;align-self:stretch}body{background-color:#f1f0ef !important}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "above svelte-7kikew");
    			add_location(div, file$2, 95, 12, 3224);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    // (85:6) {#each data as o, i}
    function create_each_block_3(ctx) {
    	let div;
    	let t0_value = (/*o*/ ctx[9].label || " ") + "";
    	let t0;
    	let t1;
    	let if_block = /*o*/ ctx[9].above && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "bar svelte-7kikew");
    			set_style(div, "left", /*o*/ ctx[9].left + "%");
    			set_style(div, "width", /*o*/ ctx[9].width + "%");
    			set_style(div, "max-height", (/*o*/ ctx[9].height || "24") + "px");
    			set_style(div, "bottom", /*o*/ ctx[9].layer * 40 + "px");
    			set_style(div, "background-color", /*o*/ ctx[9].color);
    			add_location(div, file$2, 85, 8, 2942);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (/*o*/ ctx[9].above) if_block.p(ctx, dirty);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div0 = element("div");
    			attr_dev(div0, "class", "line svelte-7kikew");
    			set_style(div0, "left", /*o*/ ctx[9].left + "%");
    			set_style(div0, "bottom", /*o*/ ctx[9].y * 5 + "px");
    			add_location(div0, file$2, 102, 10, 3438);
    			attr_dev(div1, "class", "label svelte-7kikew");
    			set_style(div1, "left", /*o*/ ctx[9].left + "%");
    			set_style(div1, "bottom", /*o*/ ctx[9].y * 75 + "px");
    			add_location(div1, file$2, 100, 8, 3341);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(100:6) {#each labels as o, i}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "left", /*o*/ ctx[9].left + "%");
    			set_style(div0, "bottom", /*o*/ ctx[9].y * 5 + "px");
    			set_style(div0, "margin-top", "-60px");
    			add_location(div0, file$2, 108, 10, 3667);
    			attr_dev(div1, "class", "label svelte-7kikew");
    			set_style(div1, "left", /*o*/ ctx[9].left + "%");
    			set_style(div1, "bottom", /*o*/ ctx[9].y * 10 + "px");
    			add_location(div1, file$2, 106, 8, 3570);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(106:6) {#each below as o, i}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "axis svelte-7kikew");
    			set_style(div, "left", /*o*/ ctx[9].left + "%");
    			add_location(div, file$2, 112, 8, 3816);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "full svelte-7kikew");
    			add_location(div0, file$2, 83, 4, 2888);
    			attr_dev(div1, "class", "row svelte-7kikew");
    			set_style(div1, "height", "400px");
    			add_location(div1, file$2, 82, 2, 2844);
    			attr_dev(div2, "class", "page");
    			set_style(div2, "background-color", "#FFFFFF");
    			add_location(div2, file$2, 81, 0, 2790);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const epoch = str => main$1(str).epoch;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("below" in $$props) $$invalidate(2, below = $$props.below);
    		if ("axis" in $$props) $$invalidate(3, axis = $$props.axis);
    	};
    	...
    	return [data, labels, below, axis];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-7kikew-style")) add_css$2();
