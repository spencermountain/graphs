var app = (function () {
    ...
    /* Users/spencer/mountain/somehow-timeline/src/shapes/Bar.svelte generated by Svelte v3.29.0 */
    const file$6 = "Users/spencer/mountain/somehow-timeline/src/shapes/Bar.svelte";

    function add_css$6() {
    	var style = element$1("style");
    	style.id = "svelte-ee50xr-style";
    	style.textContent = ".container.svelte-ee50xr{position:absolute;border-radius:2px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev$1(document.head, style);
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style$1(div, "left", /*left*/ ctx[4]);
    			set_style$1(div, "background-color", /*color*/ ctx[0]);
    			add_location$1(div, file$6, 25, 2, 596);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element$1("div");
    			add_location$1(div, file$6, 23, 2, 578);
    		},
    		m: function mount(target, anchor) {
    			insert_dev$1(target, div, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*ignore*/ ctx[5] === true) return create_if_block;
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	start = start.epoch;
    	let top = scale(start);
    	const writable_props = ["color", "width", "height", "opacity", "left", "start"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("left" in $$props) $$invalidate(4, left = $$props.left);
    		if ("start" in $$props) $$invalidate(7, start = $$props.start);
    		if ("ignore" in $$props) $$invalidate(5, ignore = $$props.ignore);
    	...
    	return [color, width, height, opacity, left, ignore, top, start];
    }
    ...
    /* 2020/nhl-playoffs/Post.svelte generated by Svelte v3.29.0 */

    const file$7 = "2020/nhl-playoffs/Post.svelte";

    function add_css$7() {
    	var style = element("style");
    	style.id = "svelte-wbpefg-style";
    	style.textContent = ".all.svelte-wbpefg{margin:3rem;position:relative}.ml4.svelte-wbpefg{margin-left:4rem}.row.svelte-wbpefg{display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.line.svelte-wbpefg{position:absolute;border-right:1px dotted grey;min-height:100%;width:75px;top:0px;color:grey;font-size:10px;line-height:100%}.labels.svelte-wbpefg{text-align:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    // (28:6) {#each teams as t}
    function create_each_block_2(ctx) {
    	let option;
    	let t_value = /*t*/ ctx[14] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			option.__value = option_value_value = /*t*/ ctx[14];
    			option.value = option.__value;
    			add_location(option, file$7, 28, 8, 673);
    		},
    		m: function mount(target, anchor) {
    ...
    // (59:12) {#each Array(playoffs[year][team] || 0) as round, i}
    function create_each_block_1(ctx) {
    	...
    	bar = new Bar({
    			props: {
    				start: "april 1 " + /*year*/ ctx[8],
    				color: /*i*/ ctx[13] === 4 ? "orange" : "blue",
    				opacity: "0.5",
    				height: "5px",
    				width: "70px",
    				left: /*i*/ ctx[13] * 75 + "px"
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(59:12) {#each Array(playoffs[year][team] || 0) as round, i}",
    		ctx
    	});
    ...
    // (57:8) {#each years as year}
    function create_each_block$1(ctx) {
    	let div;
    	let t;
    	let current;
    	let each_value_1 = Array(playoffs[/*year*/ ctx[8]][/*team*/ ctx[2]] || 0);
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "row svelte-wbpefg");
    			add_location(div, file$7, 57, 10, 1533);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*years, team*/ 12) {
    				each_value_1 = Array(playoffs[/*year*/ ctx[8]][/*team*/ ctx[2]] || 0);
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:8) {#each years as year}",
    		ctx
    	});
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			div2 = element("div");
    			div2.textContent = "semi-final";
    			t7 = space();
    			div3 = element("div");
    			div3.textContent = "final";
    			t9 = space();
    			div4 = element("div");
    			...
    			each_1_anchor = empty();
    			add_location(br0, file$7, 44, 12, 1113);
    			attr_dev(div0, "class", "line svelte-wbpefg");
    			add_location(div0, file$7, 42, 10, 1066);
    			add_location(br1, file$7, 49, 12, 1231);
    			attr_dev(div1, "class", "line svelte-wbpefg");
    			set_style(div1, "left", "75px");
    			add_location(div1, file$7, 47, 10, 1165);
    			attr_dev(div2, "class", "line svelte-wbpefg");
    			set_style(div2, "left", "150px");
    			add_location(div2, file$7, 52, 10, 1283);
    			attr_dev(div3, "class", "line svelte-wbpefg");
    			set_style(div3, "left", "225px");
    			add_location(div3, file$7, 53, 10, 1348);
    			attr_dev(div4, "class", "line svelte-wbpefg");
    			set_style(div4, "left", "300px");
    			set_style(div4, "border-right", "none");
    			add_location(div4, file$7, 54, 10, 1408);
    			attr_dev(div5, "class", "labels svelte-wbpefg");
    			add_location(div5, file$7, 41, 8, 1035);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*Array, playoffs, years, team*/ 12) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:6) <Column width=\\\"375px\\\">",
    		ctx
    	});
    ...
    // (34:4) <Timeline {start} {end} {height}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:4) <Timeline {start} {end} {height}>",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(select, "class", "ml4 svelte-wbpefg");
    			if (/*team*/ ctx[2] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[7].call(select));
    			add_location(select, file$7, 26, 4, 601);
    			attr_dev(div0, "class", "row svelte-wbpefg");
    			set_style(div0, "width", "600px");
    			add_location(div0, file$7, 25, 2, 558);
    			attr_dev(div1, "class", "all svelte-wbpefg");
    			add_location(div1, file$7, 32, 2, 743);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			...
    			select_option(select, /*team*/ ctx[2]);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	let { title = "NHL playoff appearances by time" } = $$props;
    	let { sub = "" } = $$props;
    	let team = "Toronto";
    	let years = [];
    	...
    	return [title, sub, team, years, start, end, height, select_change_handler];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-wbpefg-style")) add_css$7();
