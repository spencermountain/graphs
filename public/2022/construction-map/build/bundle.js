var app = (function (mapboxgl) {
    ...
    const file$3 = "2022/construction-map/Post.svelte";

    function add_css$3() {
    	var style = element("style");
    	style.id = "svelte-1my8cwk-style";
    	style.textContent = "#map.svelte-1my8cwk{min-width:100%;min-height:700px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }

    // (39:0) <Page {title} max={1200} padding={0} grow={true}>
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "id", "map");
    			attr_dev(div, "class", "svelte-1my8cwk");
    			add_location(div, file$3, 39, 2, 1094);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(39:0) <Page {title} max={1200} padding={0} grow={true}>",
    		ctx
    	});
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1my8cwk-style")) add_css$3();
