...
},{"./aspects":11}],13:[function(_dereq_,module,exports){
(function (global){
/*global self define*/
// calculates widths/heights according to common aspect ratios.
const findBestRatio = _dereq_('./find-best-ratio')
const parseRatio = _dereq_('./parse-ratio')
...
},{"./find-best-ratio":12,"./parse-ratio":14}],14:[function(_dereq_,module,exports){
const aspects = _dereq_('./aspects')
...
},{"./aspects":11}],15:[function(_dereq_,module,exports){
...
},{"./colors":17,"./greys":18}],20:[function(_dereq_,module,exports){
"use strict";
...
},{"./axis/XAxis":23,"./axis/YAxis":24,"./methods":27,"./scales/Scale":29,"./scales/YScale":30,"./shapes/Dot":31,"./shapes/Line":32,"./shapes/Shape":33,"./shapes/Text":34,"fit-aspect-ratio":13}],21:[function(_dereq_,module,exports){
"use strict";
...
},{"./_ticks":25}],23:[function(_dereq_,module,exports){
"use strict";
...
},{"./Axis":22}],24:[function(_dereq_,module,exports){
"use strict";
...
},{"./Axis":22}],25:[function(_dereq_,module,exports){
"use strict";
...
},{"spacetime":16}],26:[function(_dereq_,module,exports){
"use strict";
...
},{"./World":20}],27:[function(_dereq_,module,exports){
"use strict";
...
},{"./_fns":21,"./parse":28}],28:[function(_dereq_,module,exports){
"use strict";
...
},{"spacetime":16}],29:[function(_dereq_,module,exports){
"use strict";
...
},{"../parse":28,"d3-scale":7}],30:[function(_dereq_,module,exports){
"use strict";
...
},{"../parse":28,"./Scale":29,"d3-scale":7}],31:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":33,"spencer-color":19}],32:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":33,"d3-shape":8,"spencer-color":19}],33:[function(_dereq_,module,exports){
"use strict";
...
},{"../_fns":21,"./lib/parseInput":35,"flubber":15,"spencer-color":19}],34:[function(_dereq_,module,exports){
"use strict";
...
},{"./Shape":33,"spencer-color":19}],35:[function(_dereq_,module,exports){
"use strict";
...
},{"../../parse":28}],36:[function(_dereq_,module,exports){
"use strict";
...
var el = document.querySelector('#stage'); // const somehow = require('./assets/somehow');

var spacetime = _dereq_('spacetime');

var colors = _dereq_('spencer-color');

var somehow = _dereq_('/Users/spencer/mountain/somehow/src/index.js');
...
var drawTwoLines = function drawTwoLines(w, start, end, index, label, color) {
  var yearEnd = spacetime('Dec 31 2018'); //should we draw two lines?

  var yearStart = spacetime('Jan 1 2018').format('iso');
  var l1 = w.line();
  l1.color(color);
  var newEnd = spacetime(end).minus(1, 'year').format('iso');
  l1.set("".concat(yearStart, ", ").concat(index, "\n    ").concat(newEnd, ", ").concat(index));
  var l2 = w.line();
  l2.color(color);
  l2.set("".concat(start, ", ").concat(index, "\n").concat(yearEnd.format('iso'), ", ").concat(index));
};

var drawLine = function drawLine(w, start, end, index, label, color) {
  var l = w.line();
  l.color(color);
  l.set("".concat(start, ", ").concat(index, "\n").concat(end, ", ").concat(index)); // let txt = w.text(label);
  // txt.fontSize(10);
  // txt.set(`${start}, ${index}`);
};

var drawCity = function drawCity(name, id) {
  var w = somehow({
    height: 200,
    aspect: 'widescreen',
...
var chosen = Object.keys(cities).slice(0, 5);
el.innerHTML = chosen.reduce(function (str, k) {
  var id = k.replace(/[ \.,]/g, '').toLowerCase();
  str += "<div id=\"".concat(id, "\"> </div>");
  return str;
}, '');
...
},{"./data/cities":36,"/Users/spencer/mountain/somehow/src/index.js":26,"spacetime":38,"spencer-color":41}],38:[function(_dereq_,module,exports){
arguments[4][16][0].apply(exports,arguments)
},{"dup":16}],39:[function(_dereq_,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"dup":17}],40:[function(_dereq_,module,exports){
arguments[4][18][0].apply(exports,arguments)
},{"dup":18}],41:[function(_dereq_,module,exports){
arguments[4][19][0].apply(exports,arguments)
},{"./colors":39,"./greys":40,"dup":19}]},{},[37]);
