...
var getDay = function getDay(s, lat) {
  var obj = SunCalc.getTimes(s.d, lat, 0);
  var mins = spacetime(obj.sunrise).diff(obj.sunset).minutes;
  s = s.add(1, 'day');
  obj = SunCalc.getTimes(s.d, lat, 0);
  var nextDay = spacetime(obj.sunrise).diff(obj.sunset).minutes;
  var diff = nextDay - mins;
...
var getWeek = function getWeek(s, lat) {
  var obj = SunCalc.getTimes(s.d, lat, 0);
  var mins = spacetime(obj.sunrise).diff(obj.sunset).minutes;
  s = s.add(1, 'week');
  obj = SunCalc.getTimes(s.d, lat, 0);
...
var byDay = function byDay(lat, year) {
  var fall = spacetime('Sept 22 ' + year);
  var fallDay = getDay(fall, lat);
  var fallWeek = getWeek(fall, lat);
  var spring = spacetime('march 20 ' + year);
  var springDay = getDay(spring, lat);
  var springWeek = getWeek(spring, lat);
  return "<table class=\"w100p center grey mt3\">\n  <tr class=\"underline\">\n    <td>spring Equinox</td>\n    <td>fall Equinox</td>\n  </tr>\n  <tr>\n    <td ><span class=\"f2\">".concat(springDay, " mins</span> / day</td>\n    <td ><span class=\"f2\">").concat(fallDay, " mins</span> / day</td>\n  </tr>\n  <tr>\n    <td ><span class=\"f2\">").concat(springWeek, " mins</span> / week</td>\n    <td ><span class=\"f2\">").concat(fallWeek, " mins</span> / week</td>\n  </tr>\n  <table>");
};
...
var getByWeek = function getByWeek(lat) {
  var months = [];
...
var drawGraph = function drawGraph(lat) {
  ...
  line.set(byWeek);
  w.line().dotted().color('grey').width(1).set([['Jan 1 ' + year, jan], ['Dec 30 ' + year, jan]]);
  w.line().dotted().color('grey').width(1).set([['Jan 1 ' + year, aug], ['Dec 30 ' + year, aug]]);
  w.x.fit();
  w.y.fit(0, 24);
  w.xAxis.remove(); // w.xAxis.ticks(12)
...
var monthRow = months.map(function (str) {
  return "<td>".concat(str, "</td>");
});
