...
},{"dup":9}],42:[function(_dereq_,module,exports){
"use strict";
...
// over 119 years
// +0.3 per year
var diff = new Date().getFullYear() - 1900;
var inc = 37 / diff; //

var lifeSpan = function lifeSpan(year) {
  if (year < 1900) {
    return 40;
  }
...
module.exports = lifeSpan; // console.log(lifeSpan(1090))

},{}],43:[function(_dereq_,module,exports){
"use strict";

var lifespan = _dereq_('./_lifespan'); // const somehow = require('somehow')
...
var showEvents = _dereq_('./events'); // const drawWorld = require('./world')
...
var drawIt = function drawIt(gens, age, genLength, gender) {
  ...
  for (var i = 0; i < gens; i += 1) {
    var life = lifespan(d.year());
    var end = d.add(life, 'years');
...
},{"./_lifespan":42,"./events":44,"/Users/spencer/mountain/somehow/src":22,"spacetime":41}],44:[function(_dereq_,module,exports){
"use strict";
