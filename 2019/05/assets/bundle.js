...
var tick = _dereq_('./reading-tick');

var inputs = _dereq_('somehow-input');

var compute = _dereq_('./growth-compute');
...
var tail = w.area().color('lightblue');
var annotation = w.annotation().size(18).nudge(-160, 60);

var drawTail = function drawTail(rate) {
  var projection = compute(rate);
  tail.set(projection); //add annotation for total article count
  ...
  var end = projection[projection.length - 1];
...
},{"./growth-compute":1,"./reading-tick":8,"somehow":5,"somehow-input":4}],3:[function(_dereq_,module,exports){
"use strict";
...
_dereq_('./reading-init');

},{"./growth":2,"./reading-init":7}],4:[function(_dereq_,module,exports){
(function (global){
/* somehow v0.0.2
...
var findGrowth = function findGrowth(growthRate) {
  return growthPerYear(growthRate).reduce(function (h, a) {
    h[a[0].replace(/-.*/, '')] = a[1];
    return h;
  }, {});
};

var compute = function compute(wordsPerMinute, hoursPerDay, daysPerYear, growthRate) {
  var articleCount = 5793009; //5,793,009

  var wordsPerDay = wordsPerMinute * 60 * hoursPerDay;
  var pagesPerDay = wordsPerDay / wordsPerPage;
  var pagesPerYear = pagesPerDay * daysPerYear;
  var growth = findGrowth(growthRate); //compute each year
...
},{"./growth-compute":1}],7:[function(_dereq_,module,exports){
"use strict";
...
window.someState.readGraph = w; //sliders

var id = 'wordsPerMinute';
var wordsPerMinute = inputs.slider({
  id: id,
  min: 120,
...
},{"./reading-tick":8,"somehow":5,"somehow-input":4}],8:[function(_dereq_,module,exports){
"use strict";
...
var tick = function tick() {
  var w = window.someState.readGraph;
  var state = window.someState;
  var data = compute(state.wordsPerMinute, state.hoursPerDay, state.daysPerYear, state.growthRate);
  ...
  var end = ["after", "".concat(data.points.length, " years")];
