...
var years = {
  2019: _dereq_('./data/2019-toronto'),
  2018: _dereq_('./data/2018-toronto'),
  2017: _dereq_('./data/2017-toronto'),
  2016: _dereq_('./data/2016-toronto'),
  2015: _dereq_('./data/2015-toronto'),
  2014: _dereq_('./data/2014-toronto'),
...
var doYear = function doYear(year) {
  ...
  days.forEach(function (d) {
    if (d.rain) {
      var bar = w.bar().color('blue').at(d.date, d.rain);
  ...
  w.yAxis.remove();
  document.querySelector("#year".concat(year)).innerHTML = w.build();
};
