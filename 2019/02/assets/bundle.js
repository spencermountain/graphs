...
},{"spencer-color":6}],2:[function(_dereq_,module,exports){
"use strict";
...
module.exports = [{
  ...
  "wins": [1935, 1936, 1942, 1949, 1951, 1953, 1954, 1996, 1997, 2001, 2007]
}, {
  "team": "New York Rangers",
  "start": 1942,
  "history": ["New York Rangers", "1926–present"],
  "wins": [1927, 1932, 1939, 1993]
}, {
  "team": "Montreal Canadiens",
  "start": 1942,
  "history": ["Montreal Canadiens", "1910–1917 (NHA)", "1917–present (NHL)"],
  "wins": [1915, 1923, 1929, 1930, 1943, 1945, 1952, 1955, 1956, 1957, 1958, 1959, 1964, 1965, 1967, 1968, 1970, 1972, 1975, 1976, 1977, 1978, 1985, 1992]
}, {
  "team": "Boston Bruins",
  "start": 1942,
  "history": ["Boston Bruins", "1924–present"],
  "wins": [1928, 1938, 1940, 1969, 1971, 2010]
}, {
  "team": "Toronto Maple Leafs",
  "start": 1942,
  "history": ["Toronto Arenas", "1917–1919", "Toronto St. Patricks", "1919–1927", "Toronto Maple Leafs", "1927–present"],
  "wins": [1917, 1921, 1931, 1941, 1944, 1946, 1947, 1948, 1950, 1961, 1962, 1963, 1966]
}, {
  "team": "Chicago Blackhawks",
  "start": 1942,
  "history": ["Chicago Black Hawks", "1926–1986", "Chicago Blackhawks", "1986–present"],
  "wins": [1933, 1937, 1960, 2009, 2012, 2014]
}, //67
{
  ...
  "wins": [1983, 1984, 1986, 1987, 1989]
}, {
  "team": "New York Islanders",
  "start": 1972,
  "history": ["New York Islanders 1972–present"],
  "wins": [1979, 1980, 1981, 1982]
}, {
  "team": "Atlanta Flames",
  "start": 1972,
  "end": 1980,
...
var spencerColor = _dereq_('spencer-color');

var today = new Date().toISOString();
var data = [['Oct 1 1942', 6], ['Oct 1 1967', 12], //la, phili, pitsburg, st louis
...
data.forEach(function (a, i) {
  ...
  var date = a[0].replace(/Oct 1 /, 'May 1 ');
  var last = [date, data[i - 1][1]];
  points.push(last);
  points.push(a);
}); // console.log(points)
...
w.annotation(['2020', 'Seattle']).font(12).on('Sept 1 2019', -16).nudge(-80, -35); // w.fit()
...
},{"somehow":5,"spencer-color":6}],4:[function(_dereq_,module,exports){
"use strict";
...
var teams = _dereq_('./data/history');

var today = new Date().toISOString(); // teams = teams.sort((a, b) => a.start < b.start ? 1 : -1)
...
},{"./data/colors":1,"./data/history":2,"somehow":5}]},{},[4]);
