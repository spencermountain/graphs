var app = (function () {
    ...
    function add_css$2() {
    	var style = element("style");
    	style.id = "svelte-d2a07y-style";
    	style.textContent = ".m3.svelte-d2a07y{margin:3rem}.row.svelte-d2a07y{display:flex;flex-direction:row;justify-content:flex-start;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.col.svelte-d2a07y{display:flex;flex-direction:column;justify-content:flex-start;align-items:center;text-align:center;flex-wrap:nowrap;align-self:stretch}.week.svelte-d2a07y{font-size:10px;margin-top:2px;margin-left:3px;height:12px;background-color:steelblue;box-shadow:2px 2px 8px 0px rgba(0, 0, 0, 0.2);width:50px}.gap.svelte-d2a07y{height:8px}.year.svelte-d2a07y{font-size:12px;color:grey}.link.svelte-d2a07y{text-decoration:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "week svelte-d2a07y");
    			attr_dev(div, "title", div_title_value = /*wk*/ ctx[8].title);
    			add_location(div, file$2, 93, 12, 1961);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "gap svelte-d2a07y");
    			add_location(div, file$2, 91, 12, 1911);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(90:8) {#each year.weeks as wk}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(div0, "class", "year svelte-d2a07y");
    			add_location(div0, file$2, 88, 8, 1798);
    			attr_dev(div1, "class", "col svelte-d2a07y");
    			add_location(div1, file$2, 87, 6, 1772);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    			append_dev(div1, div0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(87:4) {#each byYear as year}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(sup, file$2, 82, 6, 1683);
    			attr_dev(a, "class", "link svelte-d2a07y");
    			attr_dev(a, "href", "https://en.wikipedia.org/wiki/ISO_week_date");
    			add_location(a, file$2, 81, 4, 1609);
    			attr_dev(div0, "class", "m3 svelte-d2a07y");
    			add_location(div0, file$2, 79, 2, 1550);
    			attr_dev(div1, "class", "row m3 svelte-d2a07y");
    			add_location(div1, file$2, 85, 2, 1718);
    			add_location(div2, file$2, 77, 0, 1511);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-d2a07y-style")) add_css$2();
