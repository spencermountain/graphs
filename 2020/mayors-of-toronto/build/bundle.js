var app = (function () {
    ...
    */
    ...
    const file$8 = "2020/mayors-of-toronto/Post.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:8) {#each mayors as mayor, i}",
    		ctx
    	});
    ...
    function create_default_slot_8(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(41:6) <Column width=\\\"350px\\\">",
    		ctx
    	});
    ...
    // (30:4) <Timeline {start} {end} {height} {title}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(30:4) <Timeline {start} {end} {height} {title}>",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 28, 2, 532);
    			add_location(div1, file$8, 26, 0, 496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
