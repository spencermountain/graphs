    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 22, 0, 447);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 70, 4, 3058);
    			attr_dev(div1, "class", "m3 svelte-1aoedd9");
    			add_location(div1, file$7, 68, 2, 3025);
    			attr_dev(div2, "class", "m3 svelte-1aoedd9");
    			add_location(div2, file$7, 72, 2, 3110);
    			add_location(div3, file$7, 66, 0, 2981);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
