var app = (function () {
    ...
    */
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location$1(div, file$c, 26, 0, 528);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*label*/ 16) set_data_dev$1(t, /*label*/ ctx[4]);
    ...
    class Text extends SvelteComponentDev$1 {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-ee50xr-style")) add_css$b();
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div0, "background-color", /*color*/ ctx[0]);
    			add_location$1(div0, file$d, 99, 2, 2156);
    			...
    			add_location$1(div1, file$d, 100, 2, 2232);
    ...
    /* drafts/governments-of-canada/Post.svelte generated by Svelte v3.29.0 */

    const file$e = "drafts/governments-of-canada/Post.svelte";

    function add_css$d() {
    	var style = element("style");
    	style.id = "svelte-yxebte-style";
    	style.textContent = ".m3.svelte-yxebte{margin:3rem;width:100%}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
    	append_dev(document.head, style);
    }
    ...
    function create_each_block_1(ctx) {
    	...
    	line = new Line({
    			props: {
    				start: /*row*/ ctx[2].start,
    				end: /*row*/ ctx[2].end,
    				width: "400px",
    				title: /*row*/ ctx[2].party,
    				label: /*row*/ ctx[2].party,
    				hide: true,
    				color: /*row*/ ctx[2].party === "Conservative" ? "blue" : "red",
    				opacity: /*row*/ ctx[2].majority ? 1 : 0.5
    			},
    			$$inline: true
    		});
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:6) <Column width=\\\"400px\\\">",
    		ctx
    	});
    ...
    // (32:4) <Timeline start="1867" end="Dec 30 2020" height="1400">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(32:4) <Timeline start=\\\"1867\\\" end=\\\"Dec 30 2020\\\" height=\\\"1400\\\">",
    		ctx
    	});
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "m3 svelte-yxebte");
    			add_location(div0, file$e, 30, 2, 513);
    			add_location(div1, file$e, 28, 0, 471);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$e($$self, $$props, $$invalidate) {
    	...
    	let { title = "Governments of Canada" } = $$props;
    	let { sub = "" } = $$props;
    ...
    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-yxebte-style")) add_css$d();
