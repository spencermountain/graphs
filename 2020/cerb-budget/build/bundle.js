var app = (function () {
    ...
    /* drafts/cerb-budget/Post.svelte generated by Svelte v3.22.3 */
    const file$5 = "drafts/cerb-budget/Post.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	let t5;
    	let current;
    	const head = new Head({ props: { num: "17" }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			b = element("b");
    			b.textContent = "Canada's Budget with CERB benefit";
    			t2 = space();
    			br = element("br");
    			t3 = text("\n    in 2020");
    			t4 = space();
