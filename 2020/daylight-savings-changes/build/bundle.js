var app = (function () {
    ...
    */
    ...
    /* 2020/02/Post.svelte generated by Svelte v3.22.2 */

    const file$9 = "2020/02/Post.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 43, 2, 864);
    			add_location(div1, file$9, 41, 0, 822);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	let { title = "Daylight savings time changes in 2020" } = $$props;
