var app = (function () {
    ...
    var walk$1 = function walk(s, n, fn, unit, previous) {
      ...
      if (previous !== null && startUnit !== s.d[previous]()) {
        ...
        s.epoch += milliseconds$1[unit] * diff * 0.89; // i guess?
      }
    }; //find the desired date by a increment/check while loop
    ...
    var handleArray$1 = function handleArray(s, arr) {
      ...
      for (var i = 0; i < order.length; i++) {
        var num = arr[i] || defaults$1[order[i]] || 0;
        s = s[order[i]](num);
      }
    ...
    var handleObject$1 = function handleObject(s, obj) {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        var num = obj[unit] || defaults$1[unit] || 0;
        s = s[unit](num);
      }
    ...
    var parseInput$1 = function parseInput(s, input, givenTz) {
      ...
      for (var i = 0; i < strParse$1.length; i++) {
        ...
        if (m) {
          var res = strParse$1[i].parse(s, m, givenTz);
    ...
    var spencerColor = createCommonjsModule$2(function (module, exports) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 129, 2, 2918);
    			...
    			add_location(div1, file$3, 130, 2, 3009);
    			...
    			add_location(div2, file$3, 106, 0, 2394);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	if (duration) {
    		...
    		end = src$1(start).add(Number(split[0]), split[1]).epoch;
    ...
    /* Users/spencer/mountain/somehow-timeline/src/lines/Now.svelte generated by Svelte v3.22.3 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 46, 2, 929);
    			...
    			add_location(div1, file$4, 48, 2, 1019);
    			...
    			add_location(div2, file$4, 50, 2, 1190);
    			attr_dev(div3, "class", "container svelte-hlvir2");
    			add_location(div3, file$4, 45, 0, 903);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	return [color, width, label, height, now];
    }

    class Now extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { color: 0, width: 1, label: 2, now: 4 });
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let arr = src$1(start).every(every, end);
    ...
    var somehowTicks = createCommonjsModule$2(function (module, exports) {
    /* somehow v0.0.3
    ...
    */
    ...
    /* Users/spencer/mountain/somehow-timeline/src/labels/Label.svelte generated by Svelte v3.22.3 */
    const file$6 = "Users/spencer/mountain/somehow-timeline/src/labels/Label.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 29, 0, 585);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* Users/spencer/mountain/somehow-timeline/src/labels/WideLabel.svelte generated by Svelte v3.22.3 */
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$8, 22, 0, 447);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	const scale = getContext("scale");
    	let y = scale(src$1(date).epoch);
    	console.log(left);
    	const writable_props = ["date", "label", "width", "left", "align", "color"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<WideLabel> was created with unknown prop '${key}'`);
    	});
    ...
    /* 2020/daylight-savings-changes/Post.svelte generated by Svelte v3.22.3 */

    const file$9 = "2020/daylight-savings-changes/Post.svelte";
    ...
    function create_each_block_4(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_5 = /*time*/ ctx[14].zones;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*negatives*/ 128) {
    				each_value_5 = /*time*/ ctx[14].zones;
    				validate_each_argument(each_value_5);
    				let i;
    ...
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(124:8) {#each negatives as zone, i}",
    		ctx
    	});
    ...
    // (90:6) <Timeline {start} {end} {height}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(90:6) <Timeline {start} {end} {height}>",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_2 = /*time*/ ctx[14].zones;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*positives*/ 64) {
    				each_value_2 = /*time*/ ctx[14].zones;
    				validate_each_argument(each_value_2);
    				let i;
    ...
    function create_each_block$1(ctx) {
    	...
    	let each_value_1 = /*zone*/ ctx[11].times;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*positives*/ 64) {
    				each_value_1 = /*zone*/ ctx[11].times;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(div7, t12);
    			mount_component(foot, div7, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const head_changes = {};
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	let zones = data$1.map((zone, i) => {
    		...
    		zone.times.forEach(o => {
    			let a = o.start.split(/\//);
    			let s = src({ month: Number(a[0]), date: a[1], year });
    			o.start = s.format("iso");
    			a = o.end.split(/\//);
    			s = src({ month: Number(a[0]), date: a[1], year });
    			o.end = s.format("iso");
    		});
