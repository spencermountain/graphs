var app = (function () {
    ...
    const file$3 = "components/Head.svelte";
    ...
    class Head extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-2kl8gv-style")) add_css$1();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { href: 0, title: 1, sub: 2, color: 3 });
    ...
    const file$4 = "components/Foot.svelte";
    ...
    class Foot extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-1a507ff-style")) add_css$2();
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { title: 1, year: 2 });
    ...
    const file$5 = "components/Page.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 15, 4, 411);
    			...
    			add_location(div1, file$5, 14, 2, 332);
    			attr_dev(div2, "class", "page svelte-juw3t5");
    			add_location(div2, file$5, 12, 0, 286);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		if (!document.getElementById("svelte-juw3t5-style")) add_css$3();
    ...
    /* 2020/leafs-budget/Post.svelte generated by Svelte v3.29.0 */
    const file$6 = "2020/leafs-budget/Post.svelte";
    ...
    // (10:4) <Sankey height="800" nodeWidth={125}>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(10:4) <Sankey height=\\\"800\\\" nodeWidth={125}>",
    		ctx
    	});
    ...
    // (8:0) <Page {title} sub="(in millions)">
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "margin-right", "3rem");
    			set_style(div, "margin-top", "2rem");
    			add_location(div, file$6, 8, 2, 351);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(8:0) <Page {title} sub=\\\"(in millions)\\\">",
    		ctx
    	});
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	let { title = "2019 Budget of the Toronto Maple Leafs" } = $$props;
    	...
    	$$self.$capture_state = () => ({ Sankey, Node, Col, Page, title });
