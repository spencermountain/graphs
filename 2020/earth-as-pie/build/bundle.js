var app = (function () {
    ...
    const file$5 = "Users/spencer/mountain/somehow-circle/src/Label.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element$1("div");
    			add_location$1(div, file$5, 29, 0, 584);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* 2020/earth-as-pie/Post.svelte generated by Svelte v3.29.0 */
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(50:4) {#each continents as a}",
    		ctx
    	});
    ...
    // (46:2) <Round rotate="0" margin={15}>
    function create_default_slot_1(ctx) {
    	let t0;
    	let t1;
    	let each2_anchor;
    	let current;
    	let each_value_2 = /*oceans*/ ctx[3];
    	...
    	let each_value_1 = /*continents*/ ctx[4];
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*continents*/ 16) {
    				each_value_1 = /*continents*/ ctx[4];
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(46:2) <Round rotate=\\\"0\\\" margin={15}>",
    		ctx
    	});
    ...
    // (45:0) <Page {title} {sub} grow={true} max={1000}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(45:0) <Page {title} {sub} grow={true} max={1000}>",
    		ctx
    	});
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let { title = "Earth as a pie-chart" } = $$props;
    	let { sub = "at 40° N" } = $$props;
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("oceans" in $$props) $$invalidate(3, oceans = $$props.oceans);
    		if ("continents" in $$props) $$invalidate(4, continents = $$props.continents);
    	};
    	...
    	return [title, sub, points, oceans, continents];
    }

    class Post extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { title: 0, sub: 1 });
