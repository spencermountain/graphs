// sankey layout ported from somehow-sankey (svelte lib) — computes node boxes + link polygons
// cols here are 0-indexed (the original was 1-indexed via a svelte store)
